...
import com.nvl.ecommerce_backend.request.LoginRequest;
import com.nvl.ecommerce_backend.response.AuthResponse;
import com.nvl.ecommerce_backend.service.CartService;
import com.nvl.ecommerce_backend.service.CustomerUserServiceImpl;
...
public class AuthController {
    ...
    @PostMapping("/signup")
    public ResponseEntity<AuthResponse> creaResponseHandle(@RequestBody User user) throws UserException{
