...
import com.nvl.ecommerce_backend.service.CartItemService;
...
public class CartItemController {
    ...
    public ResponseEntity<CartItem> putCartItem(@RequestBody CartItem cartItem,@PathVariable Long cartItemId, @RequestHeader("Authorization") String jwt) throws UserException, CartItemException{
        User user = userService.findUserProfileByJwt(jwt);
