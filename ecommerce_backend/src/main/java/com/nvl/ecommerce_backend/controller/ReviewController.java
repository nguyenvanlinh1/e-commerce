...
import com.nvl.ecommerce_backend.service.ReviewService;
...
public class ReviewController {
    ...
    public ResponseEntity<List<Review>> getProductsRating(@PathVariable Long productId, @RequestHeader("Authorization") String jwt) throws UserException, ProductException{
        User user = userService.findUserProfileByJwt(jwt);
