...
import { getRatingByProduct } from "../../../State/Rating/Action";
...
export default function ProductDetails() {
  ...
  const merge = review?.review && rating?.rating
  ? review.review.map(reviewItem => ({
      ...reviewItem,
      ...(rating.rating.find(ratingItem => ratingItem.productId === reviewItem.productId) || {})
    }))
  : [];
  ...
  useEffect(() => {
    ...
    dispatch(getRatingByProduct(params.productId))
    dispatch(getReviewByProduct(params.productId))
  },[params.productId])
    ...
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        <nav aria-label="Breadcrumb">
          ...
          >
            {productMain.breadcrumbs.map((breadcrumb) => (
          ...
          <div className="flex flex-col items-center">
            <div className="overflow-hidden rounded-lg max-w-[30rem] max-h-[35rem]">
              <img
                ...
                alt={productMain.images[0].alt}
                className="h-full w-full object-cover object-center"
              />
            </div>
            <div className="flex flex-wrap space-x-5 justify-center">
            {productMain.images.map((item) => <div className="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg max-w-[5rem] max-h-[5rem] mt-4">
                <img
                  src={item.src}
                  alt={item.alt}
                  className="h-full w-full object-cover object-center"
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  ...
                  <p className="ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500 cursor-pointer">3784 Reviews</p>
                </div>
              </div>
            ...
            <div className="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
              ...
              <div className="mt-10">
                ...
                <div className="mt-4">
                  <ul role="list" className="list-disc space-y-2 pl-4 text-sm">
                    {productMain.highlights.map((highlight) => (
              ...
              <div className="mt-10">
                ...
                <div className="mt-4 space-y-6">
                  <p className="text-sm text-gray-600">{productMain.details}</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <Grid container spacing={7}>
                <Grid item xs={7}>
                  <div className="space-y-5">
                    {merge?.map((item) => <ProductReviewCard item={item} />)}
                  </div>
                </Grid>
                ...
                <Grid item xs={5}>
                    <h1 className="text-xl font-semibold pb-2">Product Ratings</h1>
                      <div className="flex item-center space-x-3">
                        ...
                        <p className="opacity-60 ">50000 Ratings</p>
                      </div>
